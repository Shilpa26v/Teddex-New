...
import 'package:teddex/widgets/src/dropdwon/src/properties/clear_button_props.dart';
import 'package:teddex/widgets/src/dropdwon/src/properties/dropdown_button_props.dart';
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  InputDecoration _manageDropdownDecoration(FormFieldState state) {
    return const InputDecoration(contentPadding: EdgeInsets.fromLTRB(12, 12, 0, 0)).copyWith(
